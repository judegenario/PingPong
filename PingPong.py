# Game Ping-Pong iplementado em Python

from tkinter import * #biblioteca que acompanha a instalação padrão e permite desenvolver interfaces gráficas
import random   #com random podemos gerar numeros aleatorios
import time     #com time podemos implementar um contador

# level recebe o valor digitado pelo usuário
...
# Variável recebendo o resultado da função Canvas (Caixa de desenho)
...
class Bola:
    ...
    # Função
    def draw(self): #desenhando a forma
